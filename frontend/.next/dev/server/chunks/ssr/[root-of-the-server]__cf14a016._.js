...
function AuthProvider({ children }) {
    ...
    const login = async (email, password)=>{
        try {
            const { user: userData, token: authToken } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].login(email, password);
    ...
    const register = async (email, password, name)=>{
        try {
            const { user: userData, token: authToken } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].register(email, password, name);
            localStorage.setItem('auth-token', authToken);
            setUser(userData);
            setToken(authToken);
            router.push('/dashboard');
    ...
    const logout = async ()=>{
        if (token) {
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].logout(token);
            } catch (error) {
...
;
function Header() {
    const { user, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$auth$2f$AuthProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf14a016._.js.map